...
const ENTRIES: Entry[] = [
  ...
  // — Vorsorge / allgemeines Zahnwissen —
  {
    ...
    reply: { text: 'Bei der professionellen Dentalhygiene entfernen wir Zahnstein, Beläge und Verfärbungen, die die Zahnbürste nicht erreicht. Wir empfehlen das je nach Bedarf 1–2 Mal pro Jahr – das beugt Karies und Zahnfleischentzündungen vor.', actions: BOOK },
  },
  {
  ...
  },
  {
    ...
    reply: { text: 'Weisheitszähne müssen nicht immer entfernt werden – nur, wenn sie Beschwerden machen, sich entzünden oder keinen Platz haben. Wir beurteilen das anhand eines Röntgenbildes und beraten Sie ehrlich.', actions: BOOK },
  },
  {
