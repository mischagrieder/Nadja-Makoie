const PATHS: Record<string, string> = {
  ...
  tooth:
    'M8.5 3.8C6.7 3.8 5.2 5.1 5.2 7.3c0 2.8 1.1 4.7 1.7 7.9.3 1.7.4 3.8 1.5 3.8s.9-1.9 2.4-1.9 1.3 1.9 2.4 1.9 1.2-2.1 1.5-3.8c.6-3.2 1.7-5.1 1.7-7.9 0-2.2-1.5-3.5-3.3-3.5-1.5 0-2.2.9-3.3.9s-1.8-.9-3.3-.9z',
  shield: 'M12 3l7 3v5c0 4.4-3 7.6-7 9-4-1.4-7-4.6-7-9V6l7-3zM8.6 12l2.3 2.3L15.4 10',
  heart:
